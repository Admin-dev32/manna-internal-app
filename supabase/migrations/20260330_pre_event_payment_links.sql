...
create table if not exists public.payment_links (
  ...
  source_record_type text not null check (source_record_type in ('pre_event')),
  source_record_id uuid not null references public.pre_events (id) on delete cascade,
