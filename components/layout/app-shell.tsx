  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex min-h-screen w-full max-w-[1600px]">
        <Sidebar collapsed={isSidebarCollapsed} onToggleCollapse={() => setIsSidebarCollapsed((current) => !current)} user={session.user} />
      ...
      <MobileNav open={isMobileNavOpen} onClose={() => setIsMobileNavOpen(false)} user={session.user} />
    </div>
  );
}
