...
import { acceptQuoteAction, createQuotePaymentLinkAction, registerQuoteManualDeliveryAction, rejectQuoteAction, sendQuoteEmailAction, sendQuoteFollowupEmailAction, sendQuotePaymentReminderEmailAction } from '@/services/quotes/actions';
...
import { composeQuoteDeliveryEmail } from '@/services/quotes/email-composition';
...
export async function QuoteDetail({
  ...
  const quoteFollowupEmailAction = sendQuoteFollowupEmailAction.bind(null, quote.id);
  const quotePaymentReminderEmailAction = sendQuotePaymentReminderEmailAction.bind(null, quote.id);
  ...
  const composedEmail = await composeQuoteDeliveryEmail({
    quote,
    lead: leadRecord,
    client,
    preEvent,
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="space-y-6">
          ...
          <QuoteEmailCard
            ...
            followupAction={quoteFollowupEmailAction}
            paymentReminderAction={quotePaymentReminderEmailAction}
            ...
            preview={{
              ...
              templateResolution: composedEmail.templateSelection.resolution,
              templateName: composedEmail.templateSelection.template?.name ?? null,
              templateKey: composedEmail.templateSelection.template?.key ?? null,
              requestedLanguage: composedEmail.templateSelection.requestedLanguage,
              resolvedLanguage: composedEmail.templateSelection.resolvedLanguage,
              languageSource: composedEmail.communicationLanguage.source,
              operatorMessage: composedEmail.operatorMessage,
